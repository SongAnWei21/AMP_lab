...
class G1_21DOF_AMPLoader:
    ...
    OBS_DIM = 3 + 3 + 21 + 21 + N_KEY_BODIES * 3  # = 66
    ...
    def __init__(
        ...
        for csv_file in motion_files:
            ...
            # Extract AMP obs: lin_vel + ang_vel + joint_pos + joint_vel + key_body_pos = 66
    ...
    def get_joint_pose_batch(frames):
        # joint_pos at offset: lin_vel(3)+ang_vel(3)=6 → start
