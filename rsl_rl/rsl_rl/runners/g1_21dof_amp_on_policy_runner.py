...
from rsl_rl.utils.g1_21dof_motion_loader import G1_21DOF_AMPLoader


class G1_21DOF_AmpOnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        # init amp loader (G1_21DOF-specific: reads CSV, remaps GMR→Lab)
        amp_data = G1_21DOF_AMPLoader(
            device=device,
