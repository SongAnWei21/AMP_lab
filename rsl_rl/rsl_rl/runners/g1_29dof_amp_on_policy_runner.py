...
from rsl_rl.utils.g1_29dof_motion_loader import G1_29DOF_AMPLoader


class G1_29DOF_AmpOnPolicyRunner:
    """On-policy runner for training and evaluation of G1 29-DOF robot."""
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        # init amp loader (G1_29DOF-specific: reads CSV, remaps GMR→Lab)
        amp_data = G1_29DOF_AMPLoader(
            device=device,
