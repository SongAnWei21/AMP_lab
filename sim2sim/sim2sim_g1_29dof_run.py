"""Sim2Sim for G1 29-DOF run policy.

Strictly matches amp_run_cfg.py + g1_29dof_amp_env.py + G1_29DOF_CFG.
"""
...
# ---- Exact values from amp_run_cfg.py + G1_29DOF_CFG ----
DT = 0.005
DECIMATION = 4
ACTION_SCALE = 0.25
NUM_ACTIONS = 29
...
# Observation scales (amp_run_cfg.py normalization.obs_scales)
SCALE_ANG_VEL = 0.2
...
class MujocoRunner:
    ...
    def run(self):
        print("[INFO] Sim2Sim G1 29DOF — run policy")
