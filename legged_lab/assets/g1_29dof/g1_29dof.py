...
G1_WAIST_ROLL_EFFORT = 50
G1_WAIST_ROLL_VELOCITY = 37
G1_WAIST_PITCH_EFFORT = 50
G1_WAIST_PITCH_VELOCITY = 37
...
# Wrists
G1_WRIST_ROLL_EFFORT = 25
G1_WRIST_ROLL_VELOCITY = 37
G1_WRIST_PITCH_EFFORT = 5
G1_WRIST_PITCH_VELOCITY = 22
G1_WRIST_YAW_EFFORT = 5
G1_WRIST_YAW_VELOCITY = 22

# G1 29DOF robot model configuration
G1_29DOF_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        fix_base=False,
        replace_cylinders_with_capsules=True,
        asset_path=f"{ISAAC_ASSET_DIR}/g1_29dof/g1_29dof.urdf",
    ...
    actuators={
        ...
        "waist": ImplicitActuatorCfg(
            ...
            effort_limit_sim={
                "waist_yaw_joint": G1_WAIST_YAW_EFFORT,
                "waist_roll_joint": G1_WAIST_ROLL_EFFORT,
                "waist_pitch_joint": G1_WAIST_PITCH_EFFORT,
            },
            velocity_limit_sim={
                "waist_yaw_joint": G1_WAIST_YAW_VELOCITY,
                "waist_roll_joint": G1_WAIST_ROLL_VELOCITY,
                "waist_pitch_joint": G1_WAIST_PITCH_VELOCITY,
            },
            stiffness={
                "waist_yaw_joint": 100,
                "waist_roll_joint": 50,
            ...
            armature={
                "waist_yaw_joint": G1_ARMATURE,
                "waist_roll_joint": G1_ARMATURE,
                "waist_pitch_joint": G1_ARMATURE,
            },
        ),
        ...
        "wrists": ImplicitActuatorCfg(
            ...
            effort_limit_sim={
                ".*_wrist_roll_joint": G1_WRIST_ROLL_EFFORT,
                ".*_wrist_pitch_joint": G1_WRIST_PITCH_EFFORT,
                ".*_wrist_yaw_joint": G1_WRIST_YAW_EFFORT,
            },
            velocity_limit_sim={
                ".*_wrist_roll_joint": G1_WRIST_ROLL_VELOCITY,
                ".*_wrist_pitch_joint": G1_WRIST_PITCH_VELOCITY,
                ".*_wrist_yaw_joint": G1_WRIST_YAW_VELOCITY,
            },
            stiffness={
            ...
            armature={
                ".*_wrist_roll_joint": G1_ARMATURE,
                ".*_wrist_pitch_joint": G1_ARMATURE,
                ".*_wrist_yaw_joint": G1_ARMATURE,
            },
        ),
    },
)
