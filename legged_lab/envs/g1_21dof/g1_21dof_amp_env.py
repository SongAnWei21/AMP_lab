...
class G1_21DOF_AMP_Env(VecEnv):
    def __init__(
        self,
        cfg: G1_21DOF_AMP_WalkFlatEnvCfg | G1_21DOF_AMP_RunFlatEnvCfg,
        headless,
    ):
        self.cfg: G1_21DOF_AMP_WalkFlatEnvCfg | G1_21DOF_AMP_RunFlatEnvCfg
    ...
    def init_buffers(self):
        ...
        # Body IDs for AMP key_body_pos (must match CSV order)
    ...
    def get_amp_obs_for_expert_trans(self):
        ...
        Format matches G1_21DOF_AMPLoader output (66 dims, Lab articulation order):
            lin_vel(3) + ang_vel(3) + joint_pos(21) + joint_vel(21) + key_body_pos(18)
        """
        ...
        joint_pos = self.robot.data.joint_pos      # (N, 21)
        joint_vel = self.robot.data.joint_vel      # (N, 21)
