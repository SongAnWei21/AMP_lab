...
@configclass
class G1_21DOF_AMP_WalkRewardCfg:
    # -- task
...
@configclass
class G1_21DOF_AMP_WalkFlatEnvCfg:
    device: str = "cuda:0"
    ...
    reward = G1_21DOF_AMP_WalkRewardCfg()
...
@configclass
class G1_21DOF_AMP_WalkAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    experiment_name = "g1_21dof_amp_walk"
    run_name = ""
    logger = "tensorboard"
    resume = False
    load_run = ".*"
