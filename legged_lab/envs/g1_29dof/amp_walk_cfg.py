...
@configclass
class G1_29DOF_AMP_WalkRewardCfg:
    # -- task
...
@configclass
class G1_29DOF_AMP_WalkFlatEnvCfg:
    device: str = "cuda:0"
    ...
    reward = G1_29DOF_AMP_WalkRewardCfg()
...
@configclass
class G1_29DOF_AMP_WalkAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    experiment_name = "g1_29dof_amp_walk"
    run_name = ""
    logger = "tensorboard"
    resume = False
    load_run = ".*"
    ...
    amp_reward_coef = 1.0
    amp_motion_files = [
        "legged_lab/datasets/g1_29dof/walk_csv/Walk-B22-Side_step_left_poses.csv",
        "legged_lab/datasets/g1_29dof/walk_csv/Walk-B23-Side_step_right_poses.csv",
        "legged_lab/datasets/g1_29dof/walk_csv/Walk-B16-Walk_turn_change_poses.csv",
    ]
