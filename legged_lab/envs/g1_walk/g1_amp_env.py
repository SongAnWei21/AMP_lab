...
class G1_Walk_AMP_Env(VecEnv):
    def __init__(
        self,
        cfg: G1_WalkFlatEnvCfg,
        headless,
    ):
        self.cfg: G1_WalkFlatEnvCfg
    ...
    def get_amp_obs_for_expert_trans(self):
        """Return AMP observation in engineai_amp format: joint_pos*9 + lin_vel*7.

        Format matches G1_Walk_AMPLoader output (24 dims):
